<!-- yash --><%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
...
<h3 align="center">Applicant List</h3>    <p class="text-danger">${messages}</p><br>
    ...
    <table class="table">
        ...
        </tr>        <c:forEach var="item" items="${applicantlist}">
