...
<body
	...
	<div class="col-xs-12">
                    ...
                    <form action="EditServlet" method="post">
                        ...
                        <tr>
                            <td><br> <input type="hidden"
										name="edit" value="${applicantid}"><br> <input
        ...
        <table class="table table-condensed">
            ...
            <c:if test="${roleid.equals(2)}">
                ...
                <c:forEach items="${applicantUpdate}"
							var="applicantUpdate">
             <tr>
								<td>Updated Education:</td>
   
                        <td><c:out
										value="${applicantUpdate.education}" /></td>
                    </tr>
                </c:forEach>
            </c:if>
        </table>
            ...
            <table class="table table-condensed">
                <form action="DrugUser" method="post">
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="test1"
									value="Pass">
                            Pass</td>
                        <td><input type="radio" name="test1"
									value="Fail">
                    ...
                    <tr>
                        <td>Dot Test:</td>
                        <td><input type="radio" name="test2"
									value="Pass">
                            Pass</td>
                        <td><input type="radio" name="test2"
									value="Fail">
                    ...
                    <tr>
                        <td>Alcohol Test:</td>
                        <td><input type="radio" name="test3"
									value="Pass">
                            Pass</td>
                        <td><input type="radio" name="test3"
									value="Fail">
                ...
                <c:forEach items="${applicantUpdate}"
                    ...
                    <tr>
                        ...
                        <td><c:out
										value="${applicantUpdate.drugtestresult}" /></td>
                    </tr>
                </c:forEach>
            </table>
        </c:if>
        ...
        <c:if test="${roleid.equals(5)}">
            <form action="Citizenship" method="post">
                ...
                <br> <input type="radio" name="citizenship"
							value="No">
                Not a citizen <br> <input type="submit"
							value="submit">
            </form>
    ...
    Updated Citizenship:
     <tr>
                    <td><c:out
									value="${applicantUpdate.citizenstatus}" /></td>
                </tr>
            </c:forEach>
        </c:if>
        <br>
        ...
        <tr>
            <td><c:if
                    ...
                    <input type="hidden" name="reject"
                        ...
                        Candidate not the best fit: <input type="submit"
										value="reject">
									<br>
                    </c:forEach>
                    </form>
                    ...
                    <input type="hidden" name="reject"
										value="${candidate.applicantname}">
                        Continue with candidate: <input type="submit"
										value="Schedule">
                            </c:forEach>
                    </form>
                </c:if></td>
